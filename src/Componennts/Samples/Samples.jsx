...
const Samples = () => {
  ...
  // Function to handle SPA navigation and scroll
    ...
    <>
      ...
      <section id="samples" className="samples">
        <div className="container">
          <div className="section-header">
            <center>
              <h2 style={{ fontSize: "24px" }}>ACTIVITIES</h2>
            </center>
          </div>
                ...
                <div className="sample-card" key={index}>
                  ...
                  <div className="sample-content">
                    ...
                    <span
                      className="btn-text"
                      onClick={() =>
                        handleNavigate(`/picturepost/${item._id}`)
                      }
                    >
                      Read More <i className="fas fa-arrow-right"></i>
                    </span>
              ...
              ? videopost.slice(0, 5).map((item, index) => (
                <div className="sample-card" key={index}>
                  ...
                  <div className="sample-content">
                    ...
                    <span
                      className="btn-text"
                      onClick={() => handleNavigate(`/posts/${item._id}`)}
                    >
                      Read More <i className="fas fa-arrow-right"></i>
                    </span>
                  </div>
